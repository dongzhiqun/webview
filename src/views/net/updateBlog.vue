...
export default {
    ...
    created () {
        this.$http.get('http://172.20.10.4:8876/blog/getBlogById?id=' + this.$route.params.id).then(result => {
    ...
    methods: {
        updateBlog () {
            this.$http
                .post('http://172.20.10.4:8876/blog/updateBlog', {
                    id: this.id,
                    title: this.title,
                    link: this.link,
                    author: this.author,
